...
Below is a quick example on how to use `plotly` package to create an interactive graph of the Auckland's Maunga Whau Volcano! The same plot that is featured in the Facebook banner for this event. 
```{r}
library(plotly)
